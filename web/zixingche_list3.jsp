...
if(request.getParameter("suozaizhandian")=="" ||request.getParameter("suozaizhandian")==null ){}else{sql=sql+" and suozaizhandian like '%"+request.getParameter("suozaizhandian")+"%'";}
...
//yoxutixinxg}
%> 
  总车辆：<%=zcl%>   已租车辆：<%=yz%>    未租车辆：<%=wz%>   租车率：<%=zzcl%> %  
  </body>
</html>
