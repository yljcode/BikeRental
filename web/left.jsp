...
<body style="margin: 0; border: 0;">
        ...
        <div class="main" id="menua">
            ...
            <h3 menuid="2"  id="menu2" onclick="showsubmenu(2)" toggleGroup="on" class="menutitle"><div class="bt2"><span>车辆类型管理</span></div></h3>
				<ul id="submenu2">
					<li><a href="cheliangleixing_add.jsp" target="frmright">车辆类型添加</a></li>
					<li><a href="cheliangleixing_list.jsp" target="frmright">车辆类型查询</a></li>
				</ul>
			
			<h3 menuid="3"  id="menu3" onclick="showsubmenu(3)" toggleGroup="on" class="menutitle"><div class="bt3"><span>租赁站点管理</span></div></h3>
				<ul id="submenu3">
					<li><a href="zhandianxinxi_add.jsp" target="frmright">租赁站点添加</a></li>
					<li><a href="zhandianxinxi_list.jsp" target="frmright">租赁站点查询</a></li>
				</ul>
			
			<h3 menuid="4"  id="menu4" onclick="showsubmenu(4)" toggleGroup="on" class="menutitle"><div class="bt4"><span>站点管理员</span></div></h3>
				<ul id="submenu4">
					<li><a href="zhandianguanliyuan_add.jsp" target="frmright">站点管理员添加</a></li>
					<li><a href="zhandianguanliyuan_list.jsp" target="frmright">站点管理员查询</a></li>
				</ul>
				
			<h3 menuid="5"  id="menu5" onclick="showsubmenu(5)" togglegroup="on" class="menutitle"><div class="bt5"><span>自行车信息管理</span></div></h3>
				<ul id="submenu5">
					<li><a href="zixingche_add.jsp" target="frmright">自行车信息添加</a></li>
					<li><a href="zixingche_list.jsp" target="frmright">自行车信息查询</a></li>
				</ul>
				
			<h3 menuid="6"  id="menu6" onclick="showsubmenu(6)" toggleGroup="on" class="menutitle"><div class="bt6"><span>校园新闻</span></div></h3>
				<ul id="submenu6">
					<li><a href="xinwentongzhi_add.jsp?lb=校园新闻" target="frmright">校园新闻添加</a></li>
					<li><a href="xinwentongzhi_list.jsp?lb=校园新闻" target="frmright">校园新闻查询</a></li>
				</ul>
				
			<h3 menuid="7"  id="menu7" onclick="showsubmenu(7)" togglegroup="on" class="menutitle"><div class="bt7"><span>自行车租用统计</span></div></h3>
				<ul id="submenu7">
					
					<li><a href="zixingche_list3.jsp" target="frmright">自行车租用统计</a></li>
				</ul>
