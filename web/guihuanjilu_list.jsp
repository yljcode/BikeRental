...
<!--hxsglxiangdxongjxs-->
  ...
  <form name="form1" id="form1" method="post" action="">
   ...
   <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit2" value="导出EXCEL" style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='guihuanjilu_listxls.jsp';" />
</form>
...
//txixixngdy
    ...
    String sql =  "select * from guihuanjilu where suozaizhandian='"+request.getSession().getAttribute("zd")+"' ";
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="guihuanjilu_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="guihuanjilu_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="guihuanjilu_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
