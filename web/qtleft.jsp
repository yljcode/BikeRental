...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    ...
    if((String)request.getSession().getAttribute("username")==null || (String)request.getSession().getAttribute("username")==""){
     %>
	 <form action="jspmxyzxczlxtcdA1A2?ac=login&a=a" method="post" name="f11" style="display: inline">
           ...
           a.src="ma.jsp?d="+myDate;
                                  ...
                                  <tr>
                                    ...
                                    <td height="38" colspan="3" align="center"><input type="submit" name="Submit" value="登陆" class="hsgbutton" onclick="return checklog();" />
									 ...
									 <input type="button" name="Submit5" value="找回密码" onclick="javascript:location.href='zhmm.jsp'"; style='border:solid 1px #000000; color:#666666'></td>
                                  </tr>
