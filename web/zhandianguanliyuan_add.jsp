...
function gow()
{
	document.location.href="zhandianguanliyuan_add.jsp?id=<%=id%>";
}
</script>
<!--hxsglxiangdxongjxs-->
 <% 
...
var ajax = new AJAX();
ajax.post("factory/checkno.jsp?table=zhandianguanliyuan&col=yonghuming&value="+yonghumingobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>") 
