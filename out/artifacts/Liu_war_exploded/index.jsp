...
border=0>
  ...
  <TR>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD width=50 height=40><IMG height=35 
                  ...
                  width=30></TD>
                <TD width=817><a href="news.jsp?lb=校园新闻"><span class="red"><strong>校园新闻</strong></span></a></TD>
    ...
    for(HashMap map:new CommDAO().select("select * from xinwentongzhi where leibie='校园新闻' order by id desc ",1,9)){
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD width=44 height=40><IMG height=35 alt="" 
                  ...
                  width=32></TD>
                <TD width="487" class="red"><strong>自行车展示</strong></TD>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
          ...
          <TD class=int20>
		   ...
		   <div id="demo"  style="float:left; overflow:hidden">
				...
				<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                      <%
        for(HashMap m:new CommDAO().select("select * from zixingche order by id desc",1,8)){
         %>
	    <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" id="product">
	        <tr align="center">
              ...
              <a href="zixingchedetail.jsp?id=<%=m.get("id") %>" target=""><img src="<%=m.get("tupian") %>" border="0" title="<%=m.get("mingcheng") %>"  height="120" width="150"/></a></div></td>
	        </tr>
	        <tr align="center">
	          <td ><a href="" 
	          			target="">
