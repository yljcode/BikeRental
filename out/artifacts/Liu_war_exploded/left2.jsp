...
<body style="margin: 0; border: 0;">
        ...
        <div class="main" id="menua">
			...
			<h3 menuid="1"  id="menu1" onclick="showsubmenu(1)" toggleGroup="on" class="menutitle"><div class="bt1"><span>个人资料管理</span></div></h3>
				<ul id="submenu1">
					<li><a href="zhandianguanliyuan_updt2.jsp" target="frmright">个人资料管理</a></li>
					<li><a href="mod2.jsp" target="frmright">修改密码</a></li>
				</ul>

            <h3 menuid="2"  id="menu2" onclick="showsubmenu(2)" toggleGroup="on" class="menutitle"><div class="bt2"><span>自行车管理</span></div></h3>
				<ul id="submenu2">
					
					<li><a href="zixingche_list2.jsp" target="frmright">自行车查询</a></li>
				</ul>
			
			<h3 menuid="3"  id="menu3" onclick="showsubmenu(3)" toggleGroup="on" class="menutitle"><div class="bt3"><span>租赁记录管理</span></div></h3>
				<ul id="submenu3">
				
					<li><a href="zulinjilu_list.jsp" target="frmright">租赁记录查询</a></li>
				</ul>
			
			<h3 menuid="4"  id="menu4" onclick="showsubmenu(4)" toggleGroup="on" class="menutitle"><div class="bt4"><span>归还记录管理</span></div></h3>
				<ul id="submenu4">
					
					<li><a href="guihuanjilu_list.jsp" target="frmright">归还记录查询</a></li>
				</ul>
				
			<h3 menuid="5"  id="menu5" onclick="showsubmenu(5)" togglegroup="on" class="menutitle"><div class="bt5"><span>充值管理</span></div></h3>
				<ul id="submenu5">
					<li><a href="chongzhijilu_add.jsp" target="frmright">用户充值</a></li>
					<li><a href="chongzhijilu_list.jsp" target="frmright">充值记录</a></li>
				</ul>
				
			<!--<h3 menuid="6"  id="menu6" onclick="showsubmenu(6)" toggleGroup="on" class="menutitle"><div class="bt6"><span>站内新闻管理</span></div></h3>
				<ul id="submenu6">
					<li><a href="xinwentongzhi_add.jsp?lb=站内新闻" target="frmright">站内新闻添加</a></li>
					<li><a href="xinwentongzhi_list.jsp?lb=站内新闻" target="frmright">站内新闻查询</a></li>
				</ul>
				
			<h3 menuid="7"  id="menu7" onclick="showsubmenu(7)" togglegroup="on" class="menutitle"><div class="bt7"><span>站内新闻管理</span></div></h3>
				<ul id="submenu7">
					<li><a href="xinwentongzhi_add.jsp?lb=站内新闻" target="frmright">站内新闻添加</a></li>
					<li><a href="xinwentongzhi_list.jsp?lb=站内新闻" target="frmright">站内新闻查询</a></li>
				</ul>
			...
			<h3 menuid="18"  id="menu18" onclick="showsubmenu(18)" toggleGroup="on" class="menutitle"><div class="bt8"><span>系统管理</span></div></h3>
				<ul id="submenu18">
					...
					<li><a href="dx.jsp?lb=系统简介" target="frmright">系统简介设置</a></li>
