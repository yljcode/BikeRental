...
response.addHeader("Content-Disposition", "attachment;filename=zixingche.xls");
%>
<html>
  <head>
    <title>自行车</title>
...
//youzuiping2
  ...
  <tr>
    ...
    <td width='80' align='center'><a href="hc.jsp?id=<%=map.get("id")%>&yuan=<%=map.get("issh")%>&tablename=zixingche" onclick="return confirm('您确定要执行此操作？')"><%=map.get("issh")%></a></td>
