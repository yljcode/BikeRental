...
HashMap mmm = new CommDAO().getmap(id,"zhandianguanliyuan"); 
//lixanxdoxngcxhaxifxen
%>
  <form  action="zhandianguanliyuan_updt.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  修改站点管理员:
  <br><br>
